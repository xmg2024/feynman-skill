...
```bash
npx skills add xmg2024/feynman-skill
```
...
由 [女娲.skill](https://github.com/xmg2024/nuwa-skill) 自动生成。
...
```bash
npx skills add xmg2024/nuwa-skill
```
...
想蒸馏更多人？用 [女娲.skill](https://github.com/xmg2024/nuwa-skill)，输入任何名字即可。
